...
import { Table, Button, Pagination, Tabs, Input, Select } from 'antd';
...
const MyReqeusts = () => {
  ...
  const [sellFilters, setSellFilters] = useState({ book_title: '', seller_name: user.username, price_limit: null, status: 'All' });
  const [exchangeFilters, setExchangeFilters] = useState({ book_title: '', seller_name: user.username, description: '', status: 'All' });
  ...
  const renderStatusFilter = (filterState, onChange) => (
    <Select defaultValue="All" style={{ width: 120 }} onChange={(value) => onChange({ target: { name: 'status', value } })}>
      ...
      <Option value="Remained">Available</Option>
        ...
        <TabPane tab="Selling Requests" key="1">
          <div>
            ...
            <Input
              ...
              type="number"
            />
            {renderStatusFilter(sellFilters, onSellFilterChange)}
        ...
        <TabPane tab="Exchange Requests" key="2">
          <div>
            ...
            <Input
              ...
              style={{ margin: '0 10px 10px 0' }}
            />
            {renderStatusFilter(exchangeFilters, onExchangeFilterChange)}
